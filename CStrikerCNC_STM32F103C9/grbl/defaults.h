...
#define DEFAULT_X_STEPS_PER_MM 53.33f //Por defecto y dependiendo de los calculos
#define DEFAULT_Y_STEPS_PER_MM 53.33f
#define DEFAULT_Z_STEPS_PER_MM 250.0f //Eje no usado por la maquina
...
#define DEFAULT_SPINDLE_RPM_MAX 4096 // Valor total del PWM de la STM32
...
#define DEFAULT_HOMING_SEEK_RATE 250.0f // mm/min
...
#define DEFAULT_HOMING_INIT_LOCK 1 // Default disabled. Set to 1 to enable.
...
//No se usa el eje Z para el movimiento de la maquina
...
//#if 2_EJES_HOMING_ENABLE
//#define HOMING_CYCLE_1 (X_AXIS_BIT|Y_AXIS_BIT) // Movimiento de solo dos de los ejes
#if N_AXIS > 3
...
// INVERTIR LA LOGICA DEL ENCENDIDO DE LOS DRIVERS
